 ...
 * 推荐展馆数据适配器
 */
public class ShowroomAdapter extends RecyclerView.Adapter<ShowroomAdapter.Holder> {

    private List<Hall> mHalls;

    @Override
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_home_showroom, parent, false);
