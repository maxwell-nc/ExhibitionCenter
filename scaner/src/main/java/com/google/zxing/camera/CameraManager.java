...
public final class CameraManager {
     ...
     * encoded as message.arg1 and me.ssage.arg2, respectively.
     *
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            if (ScanConfig.scanHeight > 0 && ScanConfig.scanWidth > 0) {

                framingRect = new Rect(ScanConfig.scanLeft, ScanConfig.scanTop,
                        ScanConfig.scanLeft + ScanConfig.scanWidth,
                        ScanConfig.scanTop + ScanConfig.scanHeight);
